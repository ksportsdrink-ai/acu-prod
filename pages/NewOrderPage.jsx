...
export default function NewOrderPage() {
  ...
  const pv = done?.preview || preview?.preview
  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="max-w-lg mx-auto p-4 pb-10">
        ...
        {/* 모드 전환 */}
        <div className="flex rounded-2xl p-1 mb-5" style={{background:'var(--bg1)',border:'1px solid var(--border)'}}>
            ...
            <div>
              ...
              {form.name && (
                <p className="text-xs mt-1.5" style={{color:'var(--teal)'}}>
                  🔒 저장 시: <strong>{anonymize(form.name)}</strong>
                </p>
              )}
